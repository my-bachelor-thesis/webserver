...
type UserSolutionsTests struct {
	UserSolutionId int `json:"user_solution_id"`
	TestId         int `json:"test_id"`
	UserId         int `json:"user_id"`
}

func (ust *UserSolutionsTests) Insert() error {
...
func (ust *UserSolutionsTests) UpdateTestId() error {
...
func (ust *UserSolutionsTests) Upsert() error {
...
func getInsertFields(ust *UserSolutionsTests) (res []interface{}) {
